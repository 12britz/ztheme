...
function showHelp() {
  console.log(`
${chalk.bold.cyan('term-theme')} - Interactive terminal theme changer

${chalk.bold('Usage:')}
  term-theme                  Launch interactive mode
  term-theme list             List all available themes
  term-theme show <name>      Preview a specific theme
  term-theme apply <name>     Apply a theme directly
  term-theme help             Show this help message

${chalk.bold('Examples:')}
  ${chalk.dim('term-theme list')}
  ${chalk.dim('term-theme show dracula')}
  ${chalk.dim('term-theme apply "tokyo night"')}
`);
}
...
async function main() {
  ...
  console.clear();
  console.log(chalk.bold.cyan('╔══════════════════════════════════════╗'));
  console.log(chalk.bold.cyan('║       Terminal Theme Changer         ║'));
  console.log(chalk.bold.cyan('╚══════════════════════════════════════╝'));
  console.log();
